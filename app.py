...
def main():
    ...
    with col1:
        historico = st.slider("Historico (Años)", min_value=1, max_value=15, value=9, step=1)
    with col2:
        horizonte = st.slider("Días a pronosticar", min_value=1, max_value=30, value=7, step=1)
    st.divider()
